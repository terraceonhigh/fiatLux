...
purpose, recorded here so they do not get "fixed" by a later pass:

- `09-ground.md:91` — Maia's broken dialogue. Distress, not grammar.
- `00-ante-finem-mundi.md:17-19` — the Nadia section's present tense. Consistent
  throughout, fenced by `---`. A device.
