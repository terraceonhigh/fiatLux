...
| `planning/legacy/pedigree.md` | 99 | Earlier pedigree, since rewritten from scratch |
...
- `planning/legacy/pedigree.md` line 3 — pointed at `the-academy-brainstorm.md` as the setting reference
- `research/briefs/prepper-beekeeping.md` line 5 — named `research/pragmatics.md` as its companion in register
