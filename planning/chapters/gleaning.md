...
- `MODEL` A langar feeds everyone regardless of rank, seated together in the
  pangat. If only the poor sit there, it reads as a soup kitchen.
- `MODEL` Langar food is vegetarian (dal, roti, chai). It can set up the bone
  and sausage in Lady Swartz's broth as the class marker.
- `MODEL` Entry requires a covered head, bare feet, and washed hands. The shoe
  rack answers the footwear question, and the backpack rule (`:3`) meets the
  door.
