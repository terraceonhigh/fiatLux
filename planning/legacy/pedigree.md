...
`SUPERSEDED` Historical mixed-author pedigree. It is preserved for idea and
attribution recovery, not as authority. Use `canon/people.md` for facts derived
from the current manuscript. The older setting bible is recoverable from Git
history; see [`../../docs/history/stripped-canon.md`](../../docs/history/stripped-canon.md).
...
The former Graphviz companion was removed as a duplicate.
