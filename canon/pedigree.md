...
The groupings carry the rest: the three women shared a flat, the three children grew up together, and the three men are sorted by whether they made it onto the page.
...
**One of the three is on the page and two are not**, and that asymmetry is currently doing work whether or not it was chosen.
...
- **Leave them absent.** Two of the three households are run by a woman alone and the book simply never remarks on it, which is a register choice rather than a plot point. It also sets up the covenant descent — *by flesh or by covenant* — as the household's normal rather than its exception.
